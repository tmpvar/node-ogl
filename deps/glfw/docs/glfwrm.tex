...
\item Mac OS\textsuperscript{\textregistered} X, using Cocoa\footnote{Support for joysticks missing at the time of writing.}
\end{itemize}
...
GLFW\_OPENGL\_PROFILE    & 0                & The OpenGL profile the context should implement, or zero to disable profile selection.
...
GLFW\_OPENGL\_DEBUG\_CONTEXT & GL\_TRUE if the OpenGL context is a debug context.\\ \hline
GLFW\_OPENGL\_PROFILE    & The OpenGL profile implemented by the context, or zero.\\ \hline
\end{tabular}
\end{center}
